                  ...
                  map(sortBy(tabs[currentTab], 'created').reverse(), row => {
                    ...
                    >
                      <div className="UserData-panel-row-header">
                        <span className="UserData-panel-row-header-item">{row.id}</span>
                        <span className="UserData-panel-row-header-item">{row.created}</span>
                      </div>
                      <div className="UserData-panel-row-header">
                        <span className="UserData-panel-row-header-item">{row.type}</span>
                        <span className="UserData-panel-row-header-item">{row.reason ? row.reason : row.state}</span>
                      </div>
...
const ExchangeContent = ({ row }) => {
  return <div className="Exchange-content">
...
const VirtualItem = ({ name, image, price }) => {
  return <div className="VirtualItem-wrapper">
