...
module.exports = function(socket) {
  ...
  methods.login = function() {
    methods.request('loginWithSteam', {onSuccess: window.location.href, onFailure: window.location.href}).then(res => {
  ...
  methods.verifySteam = function() {
    return methods.request('loginWithSteamVerify', {clientToken: state.clientToken}).then(res => {
